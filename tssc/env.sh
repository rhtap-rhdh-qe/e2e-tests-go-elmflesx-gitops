...
export IMAGE_URL=${IMAGE_URL-quay.io/redhat-tssc/task-runner:1.9:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/rhtap-rhdh-qe/e2e-tests-go-elmflesx-gitops
